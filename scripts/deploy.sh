...
echo "=== BSS Queue-Based Load Leveling 패턴 배포 ==="

# 1. 네임스페이스 및 기본 설정
echo "1. 네임스페이스 및 설정 배포 중..."
...
# 4. Producer 서비스 배포
echo "4. Producer 서비스 배포 중..."
kubectl apply -f k8s/producer/

# 5. Consumer 서비스 배포
echo "5. Consumer 서비스 배포 중..."
...
echo "7. 배포 완료!"
echo "   - API 접근: http://$(minikube ip):30080"
